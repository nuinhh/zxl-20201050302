...
int main(int argc, char** argv)
{
	...
	glutInitDisplayMode(GLUT_RGB | GLUT_SINGLE);//t the display mode
	glutInitWindowSize(screenWidth, screenHeight);  //t the window size
	glutInitWindowPosition(windowPositionX, windowPositionY); //t the window position
